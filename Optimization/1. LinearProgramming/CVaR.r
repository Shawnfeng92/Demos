...
mCVaR.p$time <- system.time(
  mCVaR.p$result <- Rglpk_solve_LP(
    ...
    rhs = c(
      mCVaR.p$leverage, mCVaR.p$pL, rep(0, mCVaR.p$scenarios),
      rep(-0.01, 2 * mCVaR.p$tickers)
    ),
    types = c(
      rep("C", mCVaR.p$tickers + mCVaR.p$scenarios + 1),
